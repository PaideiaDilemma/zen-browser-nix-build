  ...
  buildEnv.mkDerivation {
    ...
    configureFlags =
      ...
      ++ [
        ...
        (lib.enableFeature true "ffmpeg")
        (lib.enableFeature false "necko-wifi")
        (lib.enableFeature true "negotiateauth")
        (lib.enableFeature false "jack")
        (lib.enableFeature true "pulseaudio")
        (lib.enableFeature true "sndio")
        (lib.enableFeature true "webrtc")
